...
class Trainer:
    ...
    def train(self):
        ...
        optimizer = torch.optim.Adadelta(model.parameters(), lr=self.params.lr, weight_decay=self.params.wdecay)
        prev_best = 0
        for epoch in range(self.params.num_epochs):
            ...
            if r_at_1 > prev_best:
                ...
                torch.save(model.state_dict(),
                           self.params.model_dir + 'best_model_weights.t7'.format(epoch + 1))
